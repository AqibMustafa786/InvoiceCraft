                ...
                <footer className="mt-auto pt-8">
                     <div className="flex justify-end mb-8">
                        <div className="w-1/3 text-sm">
                            ...
                            {(invoice.amountPaid || 0) > 0 && <div className="flex justify-between py-1 text-green-600 font-bold"><span>{t.amountPaid || 'Amount Paid'}</span><span>-{currencySymbol}{(invoice.amountPaid || 0).toFixed(2)}</span></div>}
        ...
        <div className={`p-10 font-sans text-gray-900 flex flex-col ${pageIndex < totalPages - 1 ? "page-break-after" : ""}`} style={{ minHeight: '1056px', backgroundColor: props.backgroundColor, color: textColor }}>
            ...
            <section className="grid grid-cols-3 gap-8 mb-10 text-xs">
                ...
                <div className="p-4 bg-gray-50 rounded">
                    ...
                    <p><span className="font-semibold">Due:</span> {safeFormat(invoice.dueDate, 'MMM dd, yyyy')}</p>
                </div>
