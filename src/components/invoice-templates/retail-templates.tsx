                        ...
                        <div className="w-1/3 text-xs">
                             <table className="w-full">
                                <tbody>
                                    ...
                                    {(invoice.amountPaid || 0) > 0 && <tr className="text-green-600"><td className="text-right pr-4 font-bold">{t.paid || 'PAID'}</td><td className="text-right p-1 border font-bold">-{currencySymbol}{(invoice.amountPaid || 0).toFixed(2)}</td></tr>}
                                    <tr className="font-bold"><td className="text-right pr-4">{t.total || 'TOTAL'}</td><td className="text-right p-1 border">{currencySymbol}{balanceDue.toFixed(2)}</td></tr>
                                </tbody>
                             </table>
                        </div>
                    </div>
