...
import type { Estimate, LineItem, Quote, EstimateCategory, Client } from '@/lib/types';
...
import type { HomeRemodelingInfo, RoofingInfo, HVACInfo, PlumbingInfo, ElectricalInfo, LandscapingInfo, CleaningInfo, AutoRepairInfo, ConstructionInfo, ITFreelanceInfo } from '@/lib/types';
