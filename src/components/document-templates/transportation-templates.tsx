                ...
                <footer className="mt-auto pt-8">
                    <div className="flex justify-end">
                        <div className="w-1/3 text-sm">
                            ...
                            <p className="flex justify-between font-bold text-xl mt-2 pt-2 border-t-2" style={{borderColor: accentColor}}><span>{t.amountDue || 'Amount Due'}:</span><span>{currencySymbol}{summary.grandTotal.toFixed(2)}</span></p>
                        </div>
                    </div>
...
export const TransportationTemplate4: React.FC<TemplateProps> = (props) => <TransportationTemplate1 {...props} />;
export const TransportationTemplate5: React.FC<TemplateProps> = (props) => <TransportationTemplate2 {...props} />;
