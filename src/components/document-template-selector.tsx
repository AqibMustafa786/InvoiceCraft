...
const templates: Template[] = [
  ...
  { id: 'roofing-1', name: 'PeakPro', thumbnailUrl: '/templates/roofing-1.png', category: 'Roofing Estimate', isPro: true, },
  ...
  { id: 'auto-repair-1', name: 'Gold Standard', thumbnailUrl: '/templates/auto-repair-1.png', category: 'Auto Repair Estimate', isPro: true, },
  ...
  { id: 'cleaning-2', name: 'Fresh', thumbnailUrl: '/templates/cleaning-2.png', category: 'Cleaning Estimate', isPro: true, },
  ...
  { id: 'it-1', name: 'Tech Corporate', thumbnailUrl: '/templates/it-1.png', category: 'IT / Freelance Estimate', isPro: true, },
