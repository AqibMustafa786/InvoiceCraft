    ...
    <div className="space-y-6">
      ...
      <Card className="bg-card/50 backdrop-blur-sm shadow-lg hover:shadow-primary/20 transition-shadow duration-300">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="hidden md:grid md:grid-cols-[1fr_80px_100px_100px_auto] gap-x-4 text-sm font-medium text-muted-foreground items-center">
          ...
          {invoice.lineItems.map((item, index) => (
            <div key={item.id} className="grid grid-cols-1 md:grid-cols-[1fr_80px_100px_100px_auto] gap-x-4 gap-y-2 items-center border-b pb-4">
