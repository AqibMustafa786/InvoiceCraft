...
const CategorySpecificFormFields: React.FC<{ invoice: Invoice; handleCategoryDataChange: Function; handleCategorySelectChange: Function; handleDateChange: Function }> = ({ invoice, handleCategoryDataChange, handleCategorySelectChange, handleDateChange }) => {
        ...
        case "Plumbing":
            return invoice.plumbing ? (
                <Card className="bg-card/50 backdrop-blur-sm shadow-lg">
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="space-y-2"><Label className="text-xs">Service Type</Label><CustomSelect name="serviceType" value={invoice.plumbing.serviceType} onValueChange={(name, value) => handleCategorySelectChange('plumbing', name, value)} options={plumbingServiceTypes} placeholder="Select service type" /></div>
