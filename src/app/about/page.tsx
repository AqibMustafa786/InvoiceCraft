      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {whatWeOffer.map(item => (
            <div key={item.title} className="bg-card shadow-lg rounded-lg p-6 text-center flex flex-col items-center">
              {item.icon}
       ...
       <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {whyChooseUs.map(item => (
             <div key={item.title} className="bg-card shadow-lg rounded-lg p-6">
