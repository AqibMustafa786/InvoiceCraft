...
If you are setting up a new repository, follow these commands step-by-step.
...
After you've set up the repository, pushing updates is much simpler. Follow these steps every time you want to save your changes to GitHub.
